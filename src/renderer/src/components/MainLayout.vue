  ...
  <v-app>
    ...
    <v-main>
      <RouterView v-slot="{ Component }">
        <Suspense>
          <keep-alive
            :exclude="['FileBrowser', 'CodeRepoManagement', 'AgentConfig', 'ModelConfig']"
          >
      ...
      navItems: [
        ...
        },
        {
          ...
          children: [
            ...
            { title: '研究报告', to: '/report', icon: 'mdi-microsoft-word' }
          ]
        },
        {
          title: '正在开发中...',
          ...
          children: [
            ...
            { title: '记忆闪存', to: '/scan', icon: 'mdi-credit-card-scan' },
            { title: '仓库周刊', to: '/report', icon: 'mdi-microsoft-word' },
            { title: '共享社区', to: '/report', icon: 'mdi-microsoft-word' },
          ]
        }
      ],
      isDark: false,
